...
|-----------|-------------|-----------|-------------------|
| Sequential | Internal SRAM | 9615 μs | 0.76x |
| Random | Internal SRAM | 7336 μs | 0.76x |
| Sequential | External Memory | 26328 μs | 1.16x |
| Random | External Memory | 30518 μs | 1.16x |
